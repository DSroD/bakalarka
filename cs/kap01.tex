...
konstantou. Isometrie čtyřrozměrného de Sitterova prostoročasu tvoří grupu $SO(1,4)$. De Sitterův prostoročas topologicky odpovídá
$\mathbb{R}^1 \times \mathbb{S}^3$ a lze jej tedy přirozeně reprezentovat jako vnoření hyperboloidu
\begin{equation}
...
\textcolor{red}{Dále psát o pokrytí nulovými souřadnicemi, pullback metrického tenzoru do konformního tvaru}
