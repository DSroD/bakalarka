...
\end{equation}
do pětidimenzionálního Minkowského prostoru $\mathbb{E}^{1,3}$ s metrikou
\begin{equation}
...
Hyperboloid představující de Sitterův prostoročas lze v $\mathbb{E}^{1,3}$ parametrizovat souřadnicemi $(\matu, \matv, \eta, \bar{\eta})$
...
\end{equation}
kde $\rmd s_0^2$ je metrika na $\mathbb{E}^{1,3}$ a $\Omega$ je funkcí souřadnic \textcolor{red}{Jaké jsou na $\Omega$ kladeny podmínky (aby se opravdu jednalo o konformní souřadnici)}
