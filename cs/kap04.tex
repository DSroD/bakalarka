...
Spinorový formalismus vybudujeme na základě geometrického přístupu i přes fakt, že
nejpřirozenější popis spinorů je v řeči teorie reprezentací grup, kde spolu s pinory tvoří vektory v
ireducibilních reprezentacích sudých subalgeber Cliffordových algeber, resp. v reprezentacích příslušných
