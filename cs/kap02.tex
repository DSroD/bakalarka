...
\end{equation}
\textcolor{red}{podle několika výpočtů na papíře i v Mathematice to tak je, ale nelíbí se mi chování pro $\eta \to \infty$}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \begin{tikzpicture}
            \node[inner sep=0pt, anchor=south west] (ds) at (0,0)
            {\includegraphics[width=.95\textwidth, clip]{../img/kap02/HT1_ring_matter__x-y-U_mu0_lmb1.pdf}};
        \end{tikzpicture}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \begin{tikzpicture}
            \node[inner sep=0pt, anchor=south west] (ds) at (0,0)
            {\includegraphics[width=.95\textwidth, clip]{../img/kap02/HT2_ring_matter__x-y-U_mu3_lmb1.pdf}};
        \end{tikzpicture}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \begin{tikzpicture}
            \node[inner sep=0pt, anchor=south west] (ds) at (0,0)
            {\includegraphics[width=.95\textwidth, clip]{../img/kap02/HT3_ring_matter__x-y-U_mu0_lmb-1.pdf}};
        \end{tikzpicture}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \begin{tikzpicture}
            \node[inner sep=0pt, anchor=south west] (ds) at (0,0)
            {\includegraphics[width=.95\textwidth, clip]{../img/kap02/HT4_ring_matter__x-y-U_mu3_lmb-1.pdf}};
        \end{tikzpicture}
        \caption{Hotta-Tanaka $(\Lambda = -1)$}
    \end{subfigure}
