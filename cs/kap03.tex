...
impulsní vlny. V roce 1925 odvodil Brinkmann tvar metriky 
\begin{equation}
    \rmd s^2 = \delta_{ij} \rmd x^i \rmd x^j + ...
\end{equation}
\begin{equation}
...
\subsection{Impulsní vlna s gyratonickým členem $J \propto \Theta(\matu)$}
