...
Rotující charakter zdroje je také dobře vidět z metriky za impulsní vlnou při parametrizaci reálnými souřadnicemi \eqref{eq:complex_coordinates},
...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Nulové geodetiky procházející impulsní plochou "gyratonického Hottova-Tanakova řešení\" pro de Sitterovo pozadí.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{$b_0=1, \chi=2\pi, \rho=\sqrt{2}, \Lambda = -1$}
    \end{subfigure}
    \caption{Nulové geodetiky procházející impulsní plochou "gyratonického Hottova-Tanakova řešení\" pro anti-de Sitterovo pozadí.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{$b_0=1, \chi=\pi, \rho=\sqrt{2}, \Lambda = -1$}
    \end{subfigure}
    \caption{Časupodobné geodetiky procházející impulsní plochou "gyratonického Hottova-Tanakova řešení" ve směru $\dot \matu = 0,5,~ \dot \matv = 1, \dot \eta = 0$ pro (anti-)de Sitterovo pozadí.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{$b_0=1, \chi=\pi, \rho=1, \Lambda = -1$}
    \end{subfigure}
    \caption{Časupodobné geodetiky procházející impulsní plochou "gyratonického Hottova-Tanakova řešení" ve směru $\dot \matu = 0.5, \dot \matv = 1, \dot \eta = 0.3$ pro (anti-)de Sitterovo pozadí.}
